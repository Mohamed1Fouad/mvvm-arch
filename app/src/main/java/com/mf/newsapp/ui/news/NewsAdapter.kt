...
import com.mf.newsapp.R.layout
import com.mf.newsapp.databinding.ItemNewsBinding
import com.mf.newsapp.core.data.domain.entity.model.Article
import com.mf.newsapp.ui.news.NewsAdapter.ArticlesViewHolder

class NewsAdapter(private var itemClick: (Article) -> Unit) : ListAdapter<Article, ArticlesViewHolder>(
  DIFF_CALLBACK
) {
